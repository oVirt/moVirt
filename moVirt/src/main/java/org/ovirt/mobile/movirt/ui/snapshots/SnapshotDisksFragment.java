...
public class SnapshotDisksFragment extends ResumeSyncableBaseEntityListFragment<Disk> {
    ...
    public void onRefresh() {
        entityFacade.syncAll(new ProgressBarResponse<List<Disk>>(this), filterVmId, filterSnapshotId);
    }
}
